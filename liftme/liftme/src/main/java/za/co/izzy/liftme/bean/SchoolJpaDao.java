...
import za.co.izzy.liftme.event.StudentCoursePayload;
import za.co.izzy.liftme.model.BaseEntity;
import za.co.izzy.liftme.model.Course;
import za.co.izzy.liftme.model.Person;
import za.co.izzy.liftme.model.Student;
import za.co.izzy.liftme.model.Teacher;
import za.co.izzy.liftme.qualifier.DataRepository;
import za.co.izzy.liftme.qualifier.StudentAdded;
import za.co.izzy.liftme.qualifier.StudentRemoved;
...
public class SchoolJpaDao implements SchoolDao {
	...
	/* (non-Javadoc)
	 * @see za.co.izzy.liftme.bean.SchoolDao#searchStudents(za.co.izzy.liftme.bean.SearchCriteria, int, int)
	 */
	@SuppressWarnings("unchecked")
	@Override
